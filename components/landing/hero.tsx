      ...
      <div className="max-w-7xl relative mt-20 h-[40rem] py-20 mx-auto">
        <div className="px-4 flex flex-col items-center justify-center">
          <div className="flex flex-col items-center justify-center">
            <div className="text-4xl md:text-5xl lg:text-7xl text-center font-medium">
            ...
            <div className="mt-8 flex md:flex-row flex-col md:justify-center w-full gap-4 items-center">
              <Button className="h-14 w-full md:w-44  text-lg">
                Book a Call <IconCalendarFilled className="size-4" />
              </Button>
              <Button
                variant="secondary"
                className="h-14 w-full md:w-44 text-lg"
              >
