...
export default function HeroRightGrids() {
  return (
    <div className="rotate-[28deg] dark:opacity-100 opacity-70 h-[140vh] absolute -top-20 -right-20 w-fit">
      <div className="flex items-center gap-4 h-full w-full">
        <SingleGrid
          ...
          outerClassName="w-[4.5rem] border-secondary/80 p-2"
        />
        <SingleGrid
          innerClassName="bg-gradient-to-br from-white/20 via-primary to-primary"
          outerClassName="w-[4.5rem] border-primary/20 p-2"
        />
        <SingleGrid
          innerClassName="bg-gradient-to-br from-white/20 via-primary to-primary"
          outerClassName="w-[4.5rem] border-primary/20 p-2"
