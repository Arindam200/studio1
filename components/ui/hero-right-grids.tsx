...
export default function HeroRightGrids() {
  return (
    <div className="rotate-[28deg] dark:opacity-70 md:dark:opacity-100 opacity-40 sm:opacity-70 h-[80vh] lg:h-[140vh] absolute -bottom-44 lg:-top-20 -right-36 lg:-right-20 w-fit">
