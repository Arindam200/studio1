...
export const CardBody = (content:CardContent) => (
  <div className={cn('text-left space-y-4 p-4 md:p-6 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:justify-center')}>
...
export const CardWithGridEllipsis = ({ children }: { children: React.ReactNode }) => (
    <ShineBorder color={["#A07CFE", "#FE8FB5", "#FFBE7B"]} className="border sm:w-[70rem] relative sm:h-60 rounded-md overflow-hidden bg-zinc-950 dark:border-zinc-900 p-1">
