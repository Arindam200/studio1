  ...
  return (
    <header className="fixed top-2 z-50 w-full">
      <div className="container flex h-20 max-w-screen-2xl items-center justify-between">
        ...
        <Navbar2 />
        <button className="shadow-[0_4px_14px_0_rgb(0,0,0,10%)] text-lg font-semibold hover:shadow-[0_6px_20px_rgba(93,93,93,23%)] px-8 py-2.5 bg-[#fff] text-[#696969] rounded-md transition duration-200 ease-linear">
  Contact Us
</button>
      </div>
    </header>
