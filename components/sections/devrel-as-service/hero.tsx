...
export default function Page() {
  return (
    <div className="bg-black">
      <div className="h-[44rem] max-sm:h-[36rem] overflow-scroll overflow-x-hidden w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex flex-col items-center justify-center cursor-all-scroll">
        <Navbar />
