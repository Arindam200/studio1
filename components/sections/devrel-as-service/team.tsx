...
const team = [
  {
    ...
    expertise: ['Technical Writing', 'Video Production', 'Workshop Facilitation', 'Curriculum Design'],
    achievements: ['Google Developer Expert', 'Published Author', '50+ Technical Workshops'],
    social: {
      twitter: '#',
      linkedin: '#',
      github: '#',
  ...
  },
  {
    ...
    expertise: ['Community Building', 'Event Management', 'Developer Advocacy', 'Strategic Partnerships'],
    achievements: ['100K+ Community Growth', 'AWS Community Builder', '200+ Tech Events'],
    social: {
      twitter: '#',
      linkedin: '#',
      github: '#',
  ...
  },
  {
    ...
    expertise: ['API Design', 'Developer Experience', 'Technical Architecture', 'Platform Strategy'],
    achievements: ['Microsoft MVP', 'Open Source Contributor', '30+ Integration Partners'],
    social: {
      twitter: '#',
      linkedin: '#',
      github: '#',
            ...
            >
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className={`transition-all duration-300 space-y-4 ${activeTeamMember === index ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                    <div>
      ...
      {showBooking && selectedMember && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
            <h3 className="text-2xl font-bold mb-4">Book a Meeting with {selectedMember.name}</h3>
            <p className="text-gray-600 mb-6">
              Schedule a consultation to discuss how we can help with your DevRel needs.
            </p>
