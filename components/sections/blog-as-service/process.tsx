...
import { CheckCircle2, ArrowRight, Search, LightbulbIcon, Rocket, BarChart } from 'lucide-react';

const steps = [
  {
    name: 'Discovery',
    description: 'We analyze your current content strategy and identify opportunities for improvement.',
    icon: Search,
    details: [
...
"Content strategy assessment"
  ...
  {
    name: 'Strategy',
    description: 'Develop a customized content plan aligned with your business goals and audience needs.',
    icon: LightbulbIcon,
    details: [
...
"Distribution channel selection"
  ...
  {
    name: 'Creation',
    description: 'Our expert team of technical writers produces high-quality, engaging content.',
    icon: Rocket,
    details: [
      'Content creation',
      'Community building',
  ...
  {
    name: 'Distribution',
    description: 'We publish and promote your content across multiple platforms to maximize reach.',
    icon: BarChart,
    details: [
