  ...
  return (
    <motion.div className="relative h-full">
      <div className="border-2 relative overflow-hidden h-full w-full p-6 rounded-lg shadow-lg">
        ...
        <FlickeringGrid
          className="absolute group-hover:opacity-40 opacity-10 transition-all duration-300 inset-0 rounded-xl z-[-1] size-full"
          squareSize={4}
          gridGap={6}
          color="#ea580c"
          maxOpacity={0.5}
          ...
          width={800}
        />
        <div className="text-[18rem] z-[10] font-extrabold font-primary bg-gradient-to-b from-white/80 via-white/15 to-transparent bg-clip-text text-transparent absolute bottom-[-8rem] opacity-25 right-[0rem]">
          {index + 1}
        </div>
        <div className="flex flex-col z-[50]">
          ...
          <div className="flex flex-col z-[50] mt-4 w-full gap-2">
            {item.details.map((element, index) => {
              return (
                <>
                  <div className="text-sm flex font-semibold items-center gap-2 w-full">
