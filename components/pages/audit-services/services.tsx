...
const services = [
  {
    ...
    description:
      "Evaluate how effectively your documentation and processes support new developers getting started with your product.",
    icon: IconUsers,
  },
  {
    title: "Documentation Clarity",
    description:
      "Assess accessibility and clarity of your documentation and onboarding materials for developers.",
    icon: IconFileDescription,
  },
  {
    title: "Knowledge & Documentation Audit",
    description:
      "Ensure your documentation stays current and valuable with our comprehensive knowledge management assessment.",
    icon: IconBook,
  },
  {
    title: "Workflow Navigation",
    description:
      "Test effectiveness of documentation in guiding developers through initial tasks and common workflows.",
    icon: IconCompass,
  },
  {
    title: "API Usability Audit",
    description:
      "Test your API documentation for clarity, accuracy, completeness, and developer-friendliness.",
    icon: IconApi,
  },
  {
    title: "Knowledge Access",
    description:
      "Assess how easily team members and developers can access critical information and resources.",
    icon: IconKey,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center my-10">
          ...
          <p className=" mx-auto text-foreground/80 dark:text-neutral-400 text-sm md:text-base ">
            Comprehensive audits that identify gaps and provide <br className="hidden md:block" /> actionable insights for improvement.
          </p>
        </div>
