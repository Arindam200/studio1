...
const services = [
  {
    title: "Product Demos",
    description:
      "Concise and compelling product demos that highlight the key features and benefits of your tools.",
    icon: IconVideo,
  },
  {
    title: "How-To Guides",
    description:
      "Step-by-step video guides that walk users through common tasks and workflows.",
    icon: IconListDetails,
  },
  {
    title: "Integration Videos",
    description:
      "Videos that demonstrate how to integrate your products with other tools and platforms.",
    icon: IconPlugConnected,
  },
  {
    title: "Project Explainers",
    description:
      "Videos that explain complex projects and concepts in a clear and engaging way.",
    icon: IconFileDescription,
  },
  {
    title: "Developer Onboarding",
    description:
      "Videos that accelerate developer understanding and adoption of your product.",
    icon: IconUserPlus,
  },
  {
    title: "Feature Announcements",
    description:
      "Engaging presentations of new features, updates, and capabilities.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center my-10">
          ...
          <p className=" mx-auto text-foreground/80 dark:text-neutral-400 text-sm md:text-base ">
            Professional video content that showcases your products <br className="hidden md:block" /> and educates your developer audience.
          </p>
        </div>
