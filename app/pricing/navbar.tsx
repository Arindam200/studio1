...
export default function Navbar5({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "fixed top-4 inset-x-0 max-w-2xl mx-auto z-50 rounded-md py-2 gap-6 max-md:gap-0 max-sm:mx-2 text-lg max-sm:text-sm",
        className,
      )}
    >
      <Menu setActive={setActive}>
        ...
        <Link href="/devrel-as-service">
          <p className=" font-medium text-white">DevRel</p>
        </Link>
