        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              tier.featured ? 'relative bg-gray-900 shadow-2xl border-orange-400' : 'bg-gray-800 border-orange-500 sm:mx-8 lg:mx-0',
              tier.featured
                ? ''
                : tierIdx === 0
          ...
          >
            <h3
              id={tier.id}
              className={classNames(tier.featured ? 'text-orange-400' : 'text-orange-500', 'text-base/7 font-semibold')}
            >
              {tier.name}
            </h3>
            ...
            <p className={classNames(tier.featured ? 'text-gray-300' : 'text-gray-400', 'mt-6 text-base/7')}>
              {tier.description}
            </p>
            <ul
              role="list"
            ...
            >
              {tier.features.map((feature) => (
                <li key={feature} className="flex gap-x-3">
                  <CheckIcon
                    aria-hidden="true"
                    className={classNames(tier.featured ? 'text-orange-400' : 'text-orange-500', 'h-6 w-5 flex-none')}
                  />
                  {feature}
                </li>
              ))}
            ...
            <a
              ...
              className={classNames(
                tier.featured
                  ...
                  : 'text-orange-400 ring-1 ring-inset ring-orange-400 hover:bg-gray-700 focus-visible:outline-orange-400',
