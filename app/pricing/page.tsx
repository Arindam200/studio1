...
const blogPlans = [
  {
    ...
    features: ["2 blog posts/month", "SEO optimization", "Content strategy", "1 revision/post"],
  },
  {
    name: "Growth Blog",
    price: "$999",
    description: "For scaling companies",
    features: ["4 blog posts/month", "Advanced SEO", "Content calendar", "2 revisions/post", "Social media snippets"],
  },
  {
    name: "Enterprise Blog",
    price: "Custom",
    description: "Full-scale content engine",
    features: ["Custom post volume", "Technical writer access", "Full content strategy", "Unlimited revisions", "Distribution strategy"],
  },
];
...
const devrelPlans = [
  {
    ...
    features: ["Community management", "2 technical tutorials/month", "Developer newsletter", "Basic metrics tracking"],
  },
  {
    name: "DevRel Pro",
    price: "$2,999",
    description: "Grow developer adoption",
    features: ["Full community strategy", "4 technical tutorials/month", "Developer advocacy", "Event representation", "Engagement analytics"],
  },
  {
    name: "DevRel Enterprise",
    price: "Custom",
    description: "Scale developer ecosystem",
    features: ["Custom strategy", "Dedicated DevRel team", "Content production", "Event speaking", "Community building"],
  },
];
...
const customSolutions = [
  {
    ...
    features: ["Requirements analysis", "Custom strategy", "Dedicated team", "Monthly reporting"],
  },
  {
    name: "Growth Pack",
    price: "From $9,999",
    description: "Comprehensive solutions",
    features: ["Full-scale analysis", "Integrated strategy", "Dedicated team", "Weekly reporting", "Priority support"],
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "Enterprise-grade solutions",
    features: ["Enterprise analysis", "Custom implementation", "Dedicated team", "Real-time reporting", "24/7 support"],
  },
];
        ...
        >
          <div className="mb-8">
            ...
            <div className="flex items-baseline mb-4">
              ...
              {!plan.price.includes("Custom") && !plan.price.includes("From") && (
    ...
    <div className="relative isolate bg-black px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-balance text-5xl font-semibold tracking-tight text-white sm:text-6xl">
          Choose the <span className="font-bold text-transparent bg-clip-text bg-gradient-to-b from-orange-400 via-orange-500 to-orange-600 from">Right plan </span> for you
        </p>
      </div>
      ...
      <div aria-hidden="true" className="absolute inset-x-0 top-55 -z-10 transform-gpu overflow-hidden px-36 blur-3xl">
        <div
          style={{
            clipPath:
              'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
        ...
        <div aria-hidden="true" className="absolute inset-x-0 -top-30 -z-10 transform-gpu overflow-hidden px-36 blur-3xl">
        <div
          style={{
            clipPath:
              'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
