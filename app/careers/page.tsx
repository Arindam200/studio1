      ...
      <div className="relative max-w-7xl overflow-x-hidden md:overflow-visible mx-auto">
        ...
        <section className="relative px-6 py-20 md:py-0 h-[60rem] max-h-fit flex flex-col lg:px-8">
          <div className="max-w-6xl mx-auto pt-20 pb-16 sm:pt-32 sm:pb-24">
            ...
            >
              ...
              >
                ...
                and simplify their work. Join us and help shape the future of
          ...
          >
            ...
            <motion.img
              variants={itemVariants}
              className="w-36 md:!w-60 aspect-[3/4] bg-accent/20 backdrop-blur-2xl translate-y-4 translate-x-8 transition-all duration-200 ease-linear group-hover:translate-x-10 !-rotate-6 group-hover:-rotate-[5deg]  drop-shadow-2xl border-[3px] border-muted-foreground/10 object-cover rounded-lg"
              src={amiteshNoBg.src}
              width={1000}
              height={1000}
              alt="img-1"
            ...
            <motion.img
              variants={itemVariants}
              className="w-44 md:!w-72 aspect-[3/4] bg-accent/20 backdrop-blur-2xl  z-10 shadow-3xl shadow-black border-[3px] drop-shadow-2xl  border-muted-foreground/10 object-cover rounded-lg"
              src={arindamNoBg.src}
              width={1000}
              height={1000}
              alt="img-1"
            ...
            <motion.img
              variants={itemVariants}
              className="w-36 md:!w-60 aspect-[3/4] bg-accent/20 backdrop-blur-2xl translate-y-4 -translate-x-8 transition-all duration-200 ease-linear group-hover:-translate-x-10 !rotate-6 group-hover:rotate-[5deg] drop-shadow-2xl shadow-3xl shadow-black border-[3px] border-muted-foreground/10 object-cover rounded-lg"
              src={shivayNoBg.src}
              width={1000}
              height={1000}
              alt="img-1"
