...
export const navItems = [
  {
    ...
    path: "/",
    children: [
      { title: "Top", path: "/#hero", icon: RocketLaunch },
      { title: "Trusted By", path: "/#trusted-by", icon: UsersThree },
      { title: "Offerings", path: "/#service-offerings", icon: Briefcase },
      { title: "Services", path: "/#services", icon: CheckCircle },
      { title: "Testimonials", path: "/#testimonials", icon: Star },
      { title: "Global Reach", path: "/#global-reach", icon: GlobeHemisphereWest },
      { title: "How It Works", path: "/#how-it-works", icon: RocketLaunch },
